...
# we can identify important characters such as henry, harry, dorian gray, and basil. Other NP's such as 'the picture' appear frequently as well.

# store and print the most common VP-chunks here
most_common_vp_chunks= vp_chunk_counter(vp_chunked_text)
print(most_common_vp_chunks)
# many of the most common VP's are from the first person perspective.
